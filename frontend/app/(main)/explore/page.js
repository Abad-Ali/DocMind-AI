  ...
  return (
    <div className='pt-[7vh] lg:pt-[10vh] text-white lg:pl-64 min-h-screen'>
        <div className='flex flex-col items-center'>
            <motion.div initial={{ opacity: 0, x: -70 }} viewport={{ once: true }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: "easeInOut" }} className="text-center mt-10">
            ...
            <Link href='/search'><motion.div initial={{ opacity: 0, x: 70 }} viewport={{ once: true }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: "easeInOut" }} className="relative w-xs sm:w-sm mt-5 mb-10">
